...
type DiscountsResponse struct {
	...
	Discounts []*DiscountMessage `protobuf:"bytes,1,rep,name=discounts,proto3" json:"discounts,omitempty"`
}
...
func (x *DiscountsResponse) GetDiscounts() []*DiscountMessage {
	if x != nil {
		return x.Discounts
	}
	return nil
...
type DiscountMessage struct {
	...
	DiscountPercentage int64  `protobuf:"varint,3,opt,name=discount_percentage,json=discountPercentage,proto3" json:"discount_percentage,omitempty"`
}

func (x *DiscountMessage) Reset() {
	*x = DiscountMessage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_discount_proto_discount_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *DiscountMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DiscountMessage) ProtoMessage() {}

func (x *DiscountMessage) ProtoReflect() protoreflect.Message {
	mi := &file_discount_proto_discount_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DiscountMessage.ProtoReflect.Descriptor instead.
func (*DiscountMessage) Descriptor() ([]byte, []int) {
	return file_discount_proto_discount_proto_rawDescGZIP(), []int{2}
}

func (x *DiscountMessage) GetSku() string {
	if x != nil {
		return x.Sku
	}
	return ""
...
func (x *DiscountMessage) GetCategory() string {
	if x != nil {
		return x.Category
	}
	return ""
...
func (x *DiscountMessage) GetDiscountPercentage() int64 {
	if x != nil {
...
var file_discount_proto_discount_proto_rawDesc = []byte{
	...
	,
	...
	0x61, 0x67, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x12, 0x64, 0x69, 0x73, 0x63, 0x6f,
	0x75, 0x6e, 0x74, 0x50, 0x65, 0x72, 0x63, 0x65, 0x6e, 0x74, 0x61, 0x67, 0x65, 0x32, 0x5d, 0x0a,
	0x10, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65,
	0x72, 0x12, 0x49, 0x0a, 0x0c, 0x47, 0x65, 0x74, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	0x73, 0x12, 0x1a, 0x2e, 0x64, 0x69, 0x73, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2e, 0x44, 0x69, 0x73,
	...
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x73, 0x65, 0x6d, 0x69, 0x72,
	0x6d, 0x2d, 0x64, 0x65, 0x76, 0x2f, 0x6d, 0x79, 0x74, 0x2f, 0x64, 0x69, 0x73, 0x63, 0x6f, 0x75,
...
var file_discount_proto_discount_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_discount_proto_discount_proto_goTypes = []interface{}{
	...
	(*DiscountMessage)(nil),   // 2: discount.DiscountMessage
}
var file_discount_proto_discount_proto_depIdxs = []int32{
	2, // 0: discount.DiscountsResponse.discounts:type_name -> discount.DiscountMessage
	0, // 1: discount.DiscountProvider.GetDiscounts:input_type -> discount.DiscountsRequest
	1, // 2: discount.DiscountProvider.GetDiscounts:output_type -> discount.DiscountsResponse
...
func file_discount_proto_discount_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_discount_proto_discount_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DiscountMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
